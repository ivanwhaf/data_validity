...
parser.add_argument('-project_name', type=str, help='project name', default='ema_mnist')
...
if __name__ == "__main__":
    ...
    ema = EMA(model, beta=args.beta)  # ema model!
    ...
    for epoch in range(args.epochs):
        ...
        ema.update()  # update mean teacher model(EMA) after student model backward params
    ...
    # save model
    torch.save(model.state_dict(), os.path.join(output_path, "ema_model.pth"))
    ema.restore_student()
